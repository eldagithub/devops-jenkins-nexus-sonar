...
*/
    environment {
        ...
        NEXUS_PROTOCOL = "http"
        NEXUS_URL = "nexus01:8081"
        NEXUS_REPOSITORY = "devops-release"
        NEXUS_REPO_ID    = "devops-release"
        NEXUS_CREDENTIAL_ID = "nexus-login-pwd"
...
*/
        stage('CODE ANALYSIS with SONARQUBE') {
            ...
            environment {
                scannerHome = tool 'SONARQ-4.6.2.2472'
            }
